...
def calculate_avg_base_commands(base_data):
    ...
    for (prompt, model, parameter_count, run_number, is_code_model, is_chinese_model), val in base_data.items():
        key = (prompt, model, parameter_count, is_code_model, is_chinese_model)
        sums[key] += val
        counts[key] += 1
...
unique_valid_data = load_unique_commands_data(
    "/data2/nkhajehn/watcher-mcp-server/post_processing/plots/NO_RAG_korad.csv"
)

base_data = load_base_commands_data("/data2/nkhajehn/watcher-mcp-server/post_processing/plots/NO_RAG_korad.csv")
...
'''
save_hist(prompt1, "Prompt 1", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt1_hist.png")
save_hist(prompt2, "Prompt 2", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt2_hist.png")
save_hist(prompt3, "Prompt 3", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt3_hist.png")
save_hist(prompt4, "Prompt 4", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt4_hist.png")
save_hist(prompt5, "Prompt 5", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt5_hist.png")
save_hist(prompt6, "Prompt 6", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt6_hist.png")
save_hist(prompt7, "Prompt 7", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt7_hist.png")

save_line_graph(effect_sizes_prompt1_gt, effect_sizes_prompt1_lt, "Prompt1", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt1_line_graph.png", prompt1_len_of_models_gt, prompt1_len_of_models_lt)
save_line_graph(effect_sizes_prompt2_gt,effect_sizes_prompt2_lt, "Prompt2", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt2_line_graph.png", prompt2_len_of_models_gt, prompt2_len_of_models_lt)
save_line_graph(effect_sizes_prompt3_gt, effect_sizes_prompt3_lt, "Prompt3", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt3_line_graph.png", prompt3_len_of_models_gt, prompt3_len_of_models_lt)
save_line_graph(effect_sizes_prompt4_gt, effect_sizes_prompt4_lt,"Prompt4", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt4_line_graph.png", prompt4_len_of_models_gt, prompt4_len_of_models_lt)
save_line_graph(effect_sizes_prompt5_gt, effect_sizes_prompt5_lt,"Prompt5", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt5_line_graph.png", prompt5_len_of_models_gt, prompt5_len_of_models_lt)
save_line_graph( effect_sizes_prompt6_gt,effect_sizes_prompt6_lt, "Prompt6", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt6_line_graph.png", prompt6_len_of_models_gt, prompt6_len_of_models_lt)
save_line_graph(effect_sizes_prompt7_gt, effect_sizes_prompt7_lt,"Prompt7", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt7_line_graph.png", prompt7_len_of_models_gt, prompt7_len_of_models_lt)
save_line_graph(effect_sizes_security_incremental_1_gt, effect_sizes_security_incremental_1_lt,"Prompt Security", "/data2/nkhajehn/watcher-mcp-server/hypothesis_testing/csv_files/prompt7_line_graph.png", prompt7_len_of_models_gt, prompt7_len_of_models_lt)
...
for (prompt, model, parameter_count, is_code_model, is_chinese_model), count in averaged_data.items():
    if prompt in code_models:
